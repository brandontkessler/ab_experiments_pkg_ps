...
class BaseAB:
    ...
    def plot_posteriors(posteriors, plot_title, xlabel='conversion rate', 
    ...
    def plot_relative_difference(posteriors, xlabel='percentage lift', figsize=[15, 5]):
        ...
        posterior_keys = list(posteriors.keys())
        posterior_vals = list(posteriors.values())
        ...
        plt.title(f"Relative Difference ({posterior_keys[1]} - {posterior_keys[2]})")
        plt.xlabel(xlabel)
